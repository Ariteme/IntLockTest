...
public class InitNoHardTo {
    ...
    @Test
    public void testInitNoHardTo() throws Exception {
        ...
        driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='On a scale of 1-5, how easy was it to find what you were looking for?'])[2]/following::input[2]")).click();
